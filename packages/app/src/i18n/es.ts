export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de OpenVoryel",
  ...
  "desktop.menu.ariaLabel": "Menú de OpenVoryel",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar OpenVoryel",
  "desktop.recovery.terminated": "La ventana de OpenVoryel se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "OpenVoryel no responde",
  ...
  "help.tabs.introduction": "OpenVoryel Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de OpenVoryel ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de OpenVoryel",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: OpenVoryel aún no admite la autenticación MCP.',
  ...
  "home.project.new.title": "Nuevo proyecto",
  "home.project.new.description": "Elige un nombre — su carpeta se crea por ti dentro de OpenVoryel.",
  "home.project.new.label": "Nombre del proyecto",
  "home.project.new.placeholder": "mi-proyecto",
  "home.project.new.required": "El nombre del proyecto es obligatorio",
  "home.project.new.noHome": "La carpeta personal del servidor no está disponible",
  ...
  "app.name.desktop": "OpenVoryel Desktop",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenVoryel",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenVoryel en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OpenVoryel sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenVoryel.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenVoryel",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenVoryel.",
