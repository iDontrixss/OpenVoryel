export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የOpenVoryel ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከOpenVoryel ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
